...
public class A_Checkpoint3
{
    ...
    public void testPercentCell()
    {
        ...
        Cell dateCell = grid.getCell(new TestsALL.TestLocation(0,0));
    ...
    public void testBasicRealCell()
    {
        ...
        Cell realCell = grid.getCell(new TestsALL.TestLocation(17, 3));
        assertEquals("real cell text", TestsALL.Helper.format(real), realCell.abbreviatedCellText());
    ...
    public void testMoreRealCells()
    {
        ...
        Cell zeroCell = grid.getCell(new TestsALL.TestLocation(0, 0));
        assertEquals("real cell 0", TestsALL.Helper.format(zero), zeroCell.abbreviatedCellText());
        assertEquals("real inspection 0", zero, zeroCell.fullCellText());
        String negativeTwo = "-2.0";
        grid.processCommand("B1 = " + negativeTwo);
        Cell negativeTwoCell = grid.getCell(new TestsALL.TestLocation(0, 1));
        assertEquals("real cell -2", TestsALL.Helper.format(negativeTwo), negativeTwoCell.abbreviatedCellText());
