...
public class A_Checkpoint2
{
    ...
    public void testEmptyGridCells()
    {
        for (int i = 0; i < grid.getRows(); i++)
            for (int j = 0; j < grid.getCols(); j++)
            {
                ...
                assertEquals("empty cell text", TestsALL.Helper.format(""), cell.abbreviatedCellText());
    ...
    public void testShortStringCell()
    {
        ...
        assertEquals("hello cell text", TestsALL.Helper.format(hello), helloCell.abbreviatedCellText());
    ...
    public void testLongShortStringCell()
    {
        ...
        assertEquals("greeting cell text", TestsALL.Helper.format(greeting), greetingCell.abbreviatedCellText());
    ...
    public void testEmptyStringCell()
    {
        ...
        assertEquals("empty string cell text", TestsALL.Helper.format(""), emptyStringCell.abbreviatedCellText());
    ...
    public void testProcessCommandSpecialStrings()
    {
        ...
        String inspectedSpecial1 = grid.getCell(new TestsALL.TestLocation(6,1)).fullCellText();
        assertEquals("inspected first special string", "\"" + stringSpecial1 + "\"", inspectedSpecial1);
        String inspectedSpecial2 = grid.getCell(new TestsALL.TestLocation(12,5)).fullCellText();
    ...
    public void testLowerCaseCellAssignment()
    {
        ...
        assertEquals("cell text", TestsALL.Helper.format(text), cell.abbreviatedCellText());
