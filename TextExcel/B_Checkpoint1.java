...
public class B_Checkpoint1
{
    ...
    public void testConstant()
    {
        ...
        assertEquals("constant formula value", TestsALL.Helper.format("-43.5"), cell.abbreviatedCellText());
    ...
    public void testMultiplicative()
    {
        ...
        Cell cell = grid.getCell(new TestsALL.TestLocation(0, 0));
        assertEquals("multiplicative formula value", TestsALL.Helper.format("10.0"), cell.abbreviatedCellText());
    ...
    public void testAdditive()
    {
        ...
        assertEquals("additive formula value", TestsALL.Helper.format("-3.0"), cell.abbreviatedCellText());
